...
function gotFileWriter(writer) {
	writer.write("Title,Location,Category,Sub Category,Phone IMEI No,Phone No,\n" + title + ","
			+ latitude + ":" + longitude + "," + selectedCategoryText + ","
			+ selectedSubCategory+","+IMEI+","+phone);
...
function sendMail() {
	var body = "<h1>Dear Sir/Madam,</h1><b>Title: </b>" + title
			...
			+ "<br><b>Phone IMEI No: </b>" + IMEI + "<br><b>Phone No: </b>" + phone + "<br><h1>Thanks</h1>";
